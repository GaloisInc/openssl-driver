...
unsigned char read_buf_0[32] = {
  0xDF, 0x90, 0x1F, 0x78, 0x8E, 0x75, 0x9E, 0x33, 0x30, 0x24, 0x1F, 0xBA, 0xDF, 0x53, 0x93, 0x7C,
  0xA7, 0xF0, 0x8F, 0x4B, 0xCA, 0xF7, 0xC3, 0x13, 0xE0, 0xB8, 0xDD, 0xCA, 0xFA, 0x28, 0x0A, 0x0A
};
unsigned char read_buf_1[5] = {
  0x16, 0x03, 0x01, 0x00, 0x3D
};
unsigned char read_buf_2[61] = {
  0x01, 0x00, 0x00, 0x39, 0x03, 0x01, 0x85, 0x7E, 0x11, 0x72, 0x27, 0xF4, 0xE7, 0x93, 0xCE, 0x3F,
  0x14, 0xAE, 0xD9, 0x4D, 0x7D, 0x75, 0x5D, 0xB3, 0x88, 0x0E, 0x55, 0xE6, 0x35, 0xF2, 0x80, 0x35,
  0xC4, 0xA6, 0x81, 0xE1, 0xAC, 0x29, 0x00, 0x00, 0x04, 0x00, 0x2F, 0x00, 0xFF, 0x01, 0x00, 0x00,
...
unsigned char read_buf_4[70] = {
  0x10, 0x00, 0x00, 0x42, 0x00, 0x40, 0xEC, 0xF6, 0xBD, 0xAE, 0x64, 0xFE, 0x24, 0x19, 0x08, 0x3A,
  0xD8, 0x7F, 0x3E, 0xB4, 0xAE, 0x8D, 0x52, 0xC8, 0xD0, 0x79, 0xC6, 0x57, 0x4F, 0xEF, 0xB0, 0x0C,
  0x92, 0xDC, 0xB7, 0xDF, 0x6F, 0x1A, 0x14, 0x97, 0x7A, 0x04, 0x46, 0xA1, 0xD5, 0xE9, 0x76, 0xC4,
  0xDD, 0x53, 0xBE, 0x3C, 0xC8, 0xE7, 0x79, 0xD1, 0x3A, 0x6A, 0x02, 0x1A, 0x0B, 0x06, 0x9B, 0xB8,
  0xB6, 0x7F, 0x9E, 0x25, 0xFA, 0x42
};
...
unsigned char read_buf_8[48] = {
  0x13, 0xAB, 0x80, 0x71, 0x12, 0xE7, 0x40, 0x88, 0xBE, 0xE8, 0xD1, 0xCF, 0x18, 0xF1, 0xC6, 0x03,
  0x11, 0x46, 0x40, 0x83, 0xCE, 0x76, 0x20, 0xB5, 0x39, 0x4D, 0x1C, 0x06, 0xC3, 0x5D, 0x82, 0x68,
  0xC5, 0x56, 0x98, 0xAC, 0x45, 0x29, 0xC1, 0xCA, 0x7A, 0xD3, 0x3F, 0x1E, 0x09, 0xDC, 0x4E, 0x24
};
unsigned char read_buf_9[5] = {
  0x17, 0x03, 0x01, 0x00, 0x20
};
unsigned char read_buf_10[32] = {
  0xD3, 0x50, 0x24, 0x86, 0xCA, 0x91, 0x1A, 0x83, 0x35, 0x4C, 0x85, 0x8D, 0xA1, 0x08, 0x64, 0x4E,
  0x2D, 0x46, 0xF1, 0x3A, 0x5C, 0x5F, 0x7A, 0x0B, 0x45, 0xC4, 0xDB, 0xA5, 0xE5, 0xA6, 0x68, 0xF2
};
unsigned char read_buf_11[5] = {
  0x17, 0x03, 0x01, 0x00, 0x60
};
unsigned char read_buf_12[96] = {
  0xC4, 0xAC, 0x50, 0x35, 0xDF, 0xE9, 0x93, 0x84, 0x79, 0xF4, 0xF1, 0x79, 0x3F, 0x10, 0xAD, 0x96,
  0x6D, 0x96, 0xD2, 0x35, 0x4D, 0x02, 0x5D, 0x85, 0xAC, 0x70, 0x7C, 0x7A, 0x14, 0x06, 0x68, 0x9C,
  0x6F, 0xB8, 0x6B, 0xB0, 0x9A, 0x8C, 0xB1, 0xE4, 0x56, 0xBE, 0x6A, 0xF9, 0x19, 0xEF, 0x48, 0x2E,
  0x6D, 0xD7, 0x4B, 0x3D, 0xDA, 0x19, 0x02, 0xD6, 0x64, 0xAD, 0x6A, 0xAC, 0x3A, 0xE0, 0xC0, 0xE1,
  0x10, 0xB4, 0x48, 0xC3, 0x7C, 0x09, 0xED, 0xEC, 0x4D, 0xD9, 0x50, 0x6D, 0x0B, 0xEC, 0x8B, 0xD9,
  0x4F, 0x68, 0x31, 0x18, 0xA5, 0x4E, 0xF2, 0x83, 0xBB, 0x58, 0x63, 0xB9, 0xEA, 0x6C, 0xC3, 0x68
};
